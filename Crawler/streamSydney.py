...
if __name__ == "__main__":
    ...
    rules = [tweepy.StreamRule(value='(sydney OR Ultimo OR Pyrmont OR Milsons Point OR Darlinghurst OR Woolloomooloo OR Millers Point OR Haymarket OR Surry Hills OR Neutral Bay OR Kirribilli) -is:retweet -is:reply lang:en')]
