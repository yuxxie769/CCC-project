...
if __name__ == "__main__":
    ...
    rules = [tweepy.StreamRule(value='(melbourne OR Carlton OR Docklands OR East Melbourne OR Kensington OR Flemington OR Parkville OR Southbank OR South Yarra) -is:retweet -is:reply lang:en')]
