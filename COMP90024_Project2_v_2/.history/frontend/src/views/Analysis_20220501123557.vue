...
export default {
  ...
  methods: {
    fetch_NewData(name) {
      fetch(`http://127.0.0.1:5000/analysis/${name}`)// fetch(`${process.env.VUE_APP_BACKEND_BASE_URL}analysis/${state}`)
        ...
        .then((jsonData) => {
            ...
            this.init_multi_lineChar(data, "rai_rental")
    ...
    // 折线图
    init_multi_lineChar(data, html_label){
      var chartDom = document.getElementById(html_label);
      var myChart = echarts.init(chartDom);
      var option;
      ...
      option = {
        ...
        legend: {
          data: ['Melbourne', 'Sydney', 'Brisbane', 'Adelaide']//['Email', 'Union Ads', 'Video Ads', 'Direct', 'Search Engine']
        },
        grid: {
          left: '3%',
          right: '4%',
        ...
        series: [
          {
            ...
            type: 'line',
            stack: 'Total',
            data: [29500.09843, 30251.483189999995, 31593.623300000003, 31538.1573]//[120, 132, 101, 134, 90, 230, 210]
          },
          {
            name: 'Sydney',//'Union Ads',
            type: 'line',
            stack: 'Total',
            data: [28021.130449999997, 30282.74901, 30436.63811, 30376.101889999998]//[220, 182, 191, 234, 290, 330, 310]
          },
          {
            name: 'Brisbane', //'Video Ads',
            type: 'line',
            stack: 'Total',
            data: [12787.2518, 13011.899139999998, 12707.13148, 12571.09375]//[150, 232, 201, 154, 190, 330, 410]
          },
          {
            name: 'Adelaide',   //'Direct',
            type: 'line',
            stack: 'Total',
            data: [19079.309610000004, 19472.908499999998, 19248.0069, 18806.99559]//[320, 332, 301, 334, 390, 330, 320]
          },
          // {
          //   name: 'Search Engine',
          //   type: 'line',
