...
<template>
  <div class="views">
    <div class="container">
      ...
      <div id="job_income_unemplyment" style="width: 600px;height: 400px;"></div> 
      <hr />
      <h2 class="mt-5">Population</h2>
      <div id="population" style="width: 600px;height: 400px;"></div> 
      <hr />
      <h2 class="mt-5">Unemployment Rate</h2>
      <div id="unemployment_rate" style="width: 600px;height: 400px;"></div> 
      <hr />
