...
<template>
  <div class="views">
    <div class="container">
      ...
      <div id="population" style="width: 600px;height: 400px;"></div> 
      <hr />
      ...
      option = {
        ...
        xAxis: [
          {
            type: 'category',
            axisTick: { show: false },
            data: ['Melbourne', 'Sydney', 'Brisbane', 'Adelaide']//['2012', '2013', '2014', '2015', '2016']
          }
        ],
        yAxis: [
          {
        ...
        series: [
          ...
          },
          {
            ...
            data: [242627, 449900, 112910, 256574]
          },
        ]
      };
