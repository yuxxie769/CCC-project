<template>
  <div class="views">
    <div class="container">
      ...
      <div id="Aruin_crime" style="width: 600px;height: 400px;"></div> 
      <div id="Suburb" style="width: 600px;height: 400px;"></div> 
      <hr />
      ...
      <div id="Aruin_dss_payment" style="width: 600px;height: 400px;"></div> 
      <hr />
      <h2 class="mt-5">Financial level</h2>
      <div id="twitter_income" style="width: 600px;height: 400px;"></div> 
      <div id="abs_job" style="width: 600px;height: 400px;"></div> 
      <hr />
    ...
    fetch_NewData(name) {
      fetch(`http://127.0.0.1:5000/analysis/${name}`)// fetch(`${process.env.VUE_APP_BACKEND_BASE_URL}analysis/${state}`)
        ...
        .then((jsonData) => {
            ...
            this.init_NewBarChart(data, "disabled", "twitter_dis");
            this.init_multi_lineChar_RAI(data, "rai");
            this.init_NewBarChart(data, "ndia_number", "Aruin_ndia_number");
            this.init_NewBarChart(data, "dss_payment", "Aruin_dss_payment");
            this.init_multi_BarChar(data,['Job', 'Income', 'Unemployment Rate'],"abs_job");
            this.init_NewBarChart(data, "income", "twitter_income");
